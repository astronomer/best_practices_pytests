...
LONG_POKE_INTERVAL_SECONDS = int(os.getenv("AIRFLOW_LONG_SENSOR_POKE_INTERVAL_SECONDS", "300"))
...
def _is_long_wait_sensor(call: ast.Call) -> bool:
    ...
    if isinstance(poke_interval, (int, float)) and poke_interval >= LONG_POKE_INTERVAL_SECONDS:
        return True
